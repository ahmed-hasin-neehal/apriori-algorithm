...
public class AprioriAlgorithm {
	...
	public static List<List<String>> generateFrequentItemsets(List<List<String>> transactions, int minSupportCount) {
		...
		// Step 3: Generate larger k-itemsets until no more frequent itemsets can be
		// found
		int k = 3;
	...
	public static List<List<String>> pruneItemsets(List<List<String>> transactions,
			List<List<String>> candidateItemsets, int minSupportCount) {
